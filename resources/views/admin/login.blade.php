                ...
                <div class="card shadow-lg border-0">
                    <div class="card-body p-5">
                        ...
                        <form id="otpForm" method="post" action="{{ route('admin.login') }}" class="mb-4">
                            @csrf
                            <input type="password" id="otpInput" name="otp" class="form-control visually-hidden"
                                autocomplete="off">
                            ...
                            <div class="text-center">
                                ...
                                <!-- 移动设备输入按钮 -->
                                <button type="button" class="btn btn-outline-primary d-md-none" onclick="focusInput()">
                ...
                if (validateYubicoOTP(otp)) {
                    ...
                    if (window.innerWidth < 768) {
                        autoSubmitTimeout = setTimeout(() => {
                            if (hasCompleteInput && !isVerifying) {
                                submitForm(otp);
                            }
